...
public class FirestoreConnector {
   ...
   */
  public static final class FirestorePartitionQueryCreation extends PTransform<PBegin, PCollection<PartitionQueryRequest>> {
    ...
    public PCollection<PartitionQueryRequest> expand(PBegin input) {
      ...
      return input
          ...
          .apply("Create PartitionQuery", ParDo.of(new DoFn<StructuredQuery, PartitionQueryRequest>() {
            @ProcessElement
